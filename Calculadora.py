...
def calculadora(df):
    ...
    indicadores_dim=['P1B','P2B','P3B','PBP','E1B2', 'E1B3','E2B_val','EI','E3B','E62','E63','EBP','A1B','A2B2','A2B3','ABP','RVal','R2B','RBP','RA1B','RA2B','RABP']
